...
Route::middleware('xss','setLanguage')->group(function () {
    Route::get('/', [LandingPageController::class, 'home'])->name('front.home');
    Route::get('/catalog', [LandingPageController::class, 'catalog'])->name('front.catalog');
    Route::get('/accent-2015', [LandingPageController::class, 'accent2015'])->name('front.accent2015');
    Route::get('/accent-2023', [LandingPageController::class, 'accent2023'])->name('front.accent2023');
    Route::get('/elantra-2023', [LandingPageController::class, 'elantra2023'])->name('front.elantra2023');
    Route::get('/camry-2016', [LandingPageController::class, 'camry2016'])->name('front.camry2016');
    Route::get('/sonata-2022', [LandingPageController::class, 'sonata2022'])->name('front.sonata2022');
    Route::get('/tucson-2023', [LandingPageController::class, 'tucson2023'])->name('front.tucson2023');
    Route::get('/k5-2021', [LandingPageController::class, 'k52021'])->name('front.k52021');
//    Route::get('/blog', [LandingPageController::class, 'index'])->name('front.home');
