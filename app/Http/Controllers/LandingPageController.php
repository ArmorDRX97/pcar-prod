...
class LandingPageController extends AppBaseController
{
    ...
    {
        return view('front_new.catalog');
    }

    public function accent2015()
    {
        return view('front_new.cars.accent2015');
    }
    public function accent2023()
    {
        return view('front_new.cars.accent2023');
    }

    public function elantra2023()
    {
        return view('front_new.cars.elantra2023');
    }

    public function camry2016()
    {
        return view('front_new.cars.camry2016');
    }

    public function sonata2022()
    {
        return view('front_new.cars.sonata2022');
    }

    public function tucson2023()
    {
        return view('front_new.cars.tucson2023');
    }

    public function k52021()
    {
        return view('front_new.cars.k52021');
    }
    ...
    {
        if (!empty($id)) {
            $allSubCategory = AlbumCategory::with('album', 'gallery')->where('album_id', $id)->get();
            $galleryImages = Gallery::with('album', 'media', 'category')->where('album_id', $id)->get();
