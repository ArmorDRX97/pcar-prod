                                ...
                                <div class="news-desc mb-20 position-relative mt-4">
                                    @if(!empty($galleryPost))
                                        <div class="d-flex align-items-center justify-content-between">
                                            ...
                                            <div class="custom-gallery-post fz-14 text-gray">{{$galleryPostNo}} / {{$totalGalleryPost}}</div>
                                        </div>
...
{{--                                            <img data-src="{{$galleryPost->post_gallery_image}}" alt="" src="{{ asset('front_web/images/bg-process.png') }}" class="position-relative lazy">--}}
                                            <img src="{{$galleryPost->post_gallery_image}}" alt="" class="position-relative img-fluid">
                                            <figcaption>
                            ...
                            <section class="share-this-post-section tags-post mt-2 pt-md-3">
                                <div class="row admin-desc d-flex flex-wrap justify-content-between mb-20">
                                    @if(!empty(($postDetail->tags)))
                                        <div class="col-sm-12">
                                            <h5 class="tags-post-title">{{ __('messages.post.tag') }}:</h5>
                            ...
                            <section class="post-comment-section bg-light px-30 py-4">
                                ...
                                <form id="commentForm">
                                    ...
                                    <div class="row">
                                        ...
                                        @endif
                                        <div class="col-12">
                                            <textarea class="form-control fs-14 text-gray" name="comment" id="comment" rows="3" placeholder="{{ __('messages.comment.type_your_comments') }}" required></textarea>
                                        </div>
