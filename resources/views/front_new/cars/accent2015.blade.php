...
@section('title', 'Прокат автомобиля Huyndai Accent - 2015 года без водителя по городу Астана')
@section('meta_description', 'Прокат автомобиля Huyndai Accent - 2015 года без водителя по городу Астана')
@section('content')
        ...
        <div class="container">
            <div class="row flex-md-row-reverse" id="form-first">
                <div class="col-12 col-md-3">
                    <div class="card mb-4">
                        <div class="card-img">
                            <img src="{{asset('main/img/cars/accent2015.jpg')}}" alt="" class="img-fluid">
                        </div>
                        <div class="card-body">
                            <h1 class="title" id="car-name">Huyndai Accent - 2015</h1>
                                            ...
                                            <div class="form-text" style="margin-top: 33px;">
                                                ...
                                                <div class="popup-custom">
                                                    ...
                                                    <div class="popup-block">
                                                        ...
                                                        <ul>
                                                            <li><b>1-2 @lang('main.days1'):</b> 14 000 ₸</li>
                                                            <li><b>3-5 @lang('main.days2'):</b> 13 000 ₸</li>
                                                            <li><b>6-15 @lang('main.days2'):</b> 12 000 ₸</li>
                                                            <li><b>16-30 @lang('main.days2'):</b> 11 000 ₸</li>
                                                            <li><b>30+ @lang('main.days2'):</b> 10 000 ₸</li>
                                                        </ul>
                    ...
                    <div class="card card-catalog-left">
                        <div class="card-body">
                            ...
                            <ul>
                                ...
                                <li><i class="material-symbols-outlined">done</i> <span>@lang('catalog.pr5') 30 000 ₸</span></li>
                                <li><i class="material-symbols-outlined">done</i>
